...
//|                  Omni-B3 EA v2.61 - Minicontratos B3             |
...
//|  NOVO v2.61: Janela Flutuante de Trades e Alvos Gráficos Néon     |
...
#property description "NOVO v2.61: Painel Flutuante de Operações e Alvos Virtuais Néon"

#property description "Adaptado para contas NETTING em Real (BRL)"

#property description "Versao 2.50 com Painel de Operacoes Recentes e Desenhos Graficos"
...
input string           InpSeparatorTrailing = "======== TRAILING STOP & TRAILING TP (v2.61) ========"; // ===================
        ...
        if(state.oldest_level_time > 0) {
            ...
            if(oldest_dt.year < current_dt.year || 
               ...
               (oldest_dt.year == current_dt.year && oldest_dt.mon == current_dt.mon && oldest_dt.day < current_dt.day)) {
                ...
                Logger.Warning("EA", StringFormat("[PROTECAO] Salvaguarda Day Trade acionada! Detectada posiço antiga de %04d.%02d.%02d. Liquidando toda a grade a mercado.", 
